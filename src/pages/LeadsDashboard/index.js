...
export default class LeadsDashboard extends Component {
    state = {
        data: [],
        dataInfo: [],
        load: false
    ...
    getData = async (page = 1) => {
        ...
        await api.get(`/user?paginate=true&page=${page}&sortBy=price&order=asc`)
            .then(res => {
    ...
    render() {
        ...
        return (
            <>
                <Layout pageName="Leads" pageUrl="/leads">
                    <Container fluid>
                        <Row>
